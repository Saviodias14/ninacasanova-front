...
import convite from "../../assets/NinaConvite.jpeg"
...
export default function HomePage() {
    ...
    return (
        <MainlyBackground>
            ...
            <Buttons>
                <button onClick={()=>navigate('/rsvp')}>Confirmar presença</button>
                <button onClick={()=>navigate('/list')}>Ver lista de presentes</button>
            </Buttons>
        </MainlyBackground>
    )
}
